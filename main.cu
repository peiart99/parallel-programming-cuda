...
void init(int array_length, int reach, float *data_array, float *out_array, float *device_data_array, float *device_out_array, size_t bytes_data, size_t bytes_out)
{
...
int main()
{
    ...
    init(array_length, reach, data_array, out_array, device_data_array, device_out_array, bytes_data, bytes_out);
